...
const PDFreport = async (reportData, startDate, endDate) => {
  ...
  document.text(`Generated on: ${currentDate}`, marginLeft, document.internal.pageSize.height - 30);
  document.text(`Generated by: ${generatedBy}`, marginLeft, document.internal.pageSize.height - 20);
