...
const PDFreport = async (reportData, startDate, endDate) => {
  ...
  document.text("Maczela's Pizza Sales Report", marginLeft, 60);
  document.text(generatedDate, marginLeft, 90);
  document.text("Generated by: Josh Domingo", marginLeft, 110);
